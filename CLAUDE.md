...
This repository's agent guidance lives in [`AGENTS.md`](AGENTS.md) — a single source of truth shared across Claude Code, Codex, Cursor, Aider, and other agentic CLIs.
